                  ...
                  <div class="col-lg-8">
                    <div>
                      ...
                      <div class="rotate-img">
                        <img src="images/inner/inner_1.jpg" alt="banner" class="img-fluid mt-4 mb-4" />
                      </div>
                      <p class="mb-4 fs-15">
                    ...
                    <div>
                      ...
                      <div class="rotate-img">
                        <img src="images/inner/inner_2.jpg" alt="banner" class="img-fluid mt-4 mb-4" />
                      </div>
                      <p class="mb-4 fs-15">
                        He has led a remarkable campaign, defying the
                        traditional mainstream parties courtesy of his En
                    ...
                    <div>
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="rotate-img">
                            <img src="images/inner/inner_3.jpg" alt="banner" class="img-fluid mt-4 mb-4" />
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="rotate-img">
                            <img src="images/inner/inner_4.jpg" alt="banner" class="img-fluid mt-4 mb-4" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-12">
                        <div class="border-bottom pb-4 pt-4">
                          <div class="row">
                            ...
                            <div class="col-sm-4">
                              <div class="rotate-img">
                                <img src="images/inner/inner_7.jpg" alt="banner" class="img-fluid" />
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-sm-12">
                        <div class="border-bottom pb-4 pt-4">
                          <div class="row">
                            ...
                            <div class="col-sm-4">
                              <div class="rotate-img">
                                <img src=" images/inner/inner_8.jpg" alt="banner" class="img-fluid" />
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-sm-12">
                        <div class="pt-4">
                          <div class="row">
                            ...
                            <div class="col-sm-4">
                              <div class="rotate-img">
                                <img src=" images/inner/inner_9.jpg" alt="banner" class="img-fluid" />
                              </div>
                            </div>
                          </div>
                        </div>
